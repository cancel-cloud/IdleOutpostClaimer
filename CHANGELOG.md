...
- Added the new weekly free gems store reward (`100 Free Gems`) to the automatic claim flow.
- Added the Xsolla free-item endpoint for `com.rockbite.zombieoutpost.webshop.weeklygems`.
